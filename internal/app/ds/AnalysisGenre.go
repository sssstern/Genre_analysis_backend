...
type AnalysisGenre struct {
	AnalysisRequestID  int    `gorm:"primaryKey;not null;uniqueIndex:idx_analysis_genre;column:analysis_request_id" json:"-"`
	...
	ProbabilityPercent int    `gorm:"default:0;column:probability_percent"`
